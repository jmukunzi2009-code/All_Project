...
export const navbarStyles = {
  ...
  searchContainer: "relative hidden lg:flex items-center",
  searchInput: "w-64 px-4 py-2.5 pl-10 pr-4 rounded-full border border-emerald-200 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 text-sm placeholder-gray-400",
  searchIcon: "absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400",
  searchButton: "absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 rounded-full bg-emerald-500 text-white hover:bg-emerald-600 transition-colors duration-200",
  searchResults: "absolute top-full left-0 right-0 mt-2 bg-white border border-emerald-200 rounded-lg shadow-lg z-50 max-h-64 overflow-y-auto",
  searchResultItem: "px-4 py-3 hover:bg-emerald-50 cursor-pointer border-b border-gray-100 last:border-b-0",
  searchResultTitle: "font-medium text-gray-900",
  searchResultSubtitle: "text-sm text-gray-500",
  mobileSearchToggle: "lg:hidden p-2 rounded-lg hover:bg-emerald-50 transition-colors",
  mobileSearchContainer: "lg:hidden px-4 pb-4 border-t border-emerald-100 pt-4",
  mobileSearchInput: "w-full px-4 py-3 pl-10 rounded-lg border border-emerald-200 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 text-sm placeholder-gray-400",
  ...
  dashboardButton: "hidden lg:inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-emerald-100 text-emerald-700 hover:bg-emerald-200 transition-all duration-300",
  dashboardIcon: "w-4 h-4",
  dashboardText: "hidden lg:text-xs lg:whitespace-nowrap sm:inline-block",
