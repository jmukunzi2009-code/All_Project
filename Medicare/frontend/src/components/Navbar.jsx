...
import { User, Key, Menu, X, Search, MapPin, Phone, Clock, Bell, Shield } from 'lucide-react';
          ...
          <div className={navbarStyles.flexContainer}>
            ...
            <div className={navbarStyles.rightContainer}>
              <SignedOut>
                ...
                <Link to="/admin/login" className="hidden lg:inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-semibold bg-orange-100 text-orange-700 hover:bg-orange-200 transition-all duration-300">
                  <Shield className="w-4 h-4" />
                  <span className="hidden lg:text-xs lg:whitespace-nowrap sm:inline-block">Admin</span>
                </Link>
              ...
              <SignedIn>
                <button
                  ...
                  className="hidden lg:inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-semibold bg-gray-100 text-gray-700 hover:bg-gray-200 transition-all duration-300"
                >
